      ...
      <div className="md:flex items-center">
        ...
        <div className="flex flex-col md:flex-row items-center w-full">
          <input
            ...
            type="text"
            placeholder="Enter code"
            className="flex-1 px-4 py-2 border rounded-3xl mb-2 md:mb-0 md:-mr-20 w-full md:w-auto"
          />
          <button className="bg-gray-800 text-white border rounded-3xl w-full md:w-auto h-11 md:h-auto px-4 py-2">
            Apply Coupon
          </button>
        </div>
      </div>
