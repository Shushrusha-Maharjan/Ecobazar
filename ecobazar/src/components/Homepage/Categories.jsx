  ...
  return (
    <section>
      <div className="md:container md:px-28 md:mx-auto space-x-11 gap-4">
        ...
        <div className="md:container shadow-lg flex justify-between mt-5 mb-2 gap-5 hidden md:flex">
          <div className="flex justify-between gap-3 pl-4">
            <div>
              <LiaShippingFastSolid size={40} color="#00B207" />
            </div>
        ...
        <div className="md:hidden">
          <div className="grid grid-cols-1 gap-5 mt-5">
            <div className="bg-white shadow-lg flex flex-col justify-center items-center p-4 rounded-lg">
              <LiaShippingFastSolid size={40} color="#00B207" />
